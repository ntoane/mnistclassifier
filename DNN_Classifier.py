...
# The hidden layer1 has 128 neurons
# The hidden layer2 has 64 neurons
...
hidden1_size = 128 # hidden layer1
hidden2_size = 64 # hidden layer2
output_size = 10 # output layer

# Build the network by combining the layers in sequence
# Then apply ReLU to hidden layer1, Tanh to hidden layer2 and Softmax to output layer
model = nn.Sequential(
